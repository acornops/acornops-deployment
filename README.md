...
The profile enables only the eight-scope platform-admin BFF contract,
...
- Platform-admin console: `http://127.0.0.1:4173/`
...
- Platform-admin Keycloak realm: `http://localhost:8082/realms/acornops-platform-admin`

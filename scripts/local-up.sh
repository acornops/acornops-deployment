...
configure_local_platform_admin() {
  ...
  export ADMIN_SESSION_MAX_AGE_SECONDS="${ADMIN_SESSION_MAX_AGE_SECONDS:-604800}"
  export ADMIN_SESSION_IDLE_TIMEOUT_SECONDS="${ADMIN_SESSION_IDLE_TIMEOUT_SECONDS:-86400}"
  export ADMIN_SESSION_REAUTH_SECONDS="${ADMIN_SESSION_REAUTH_SECONDS:-86400}"
